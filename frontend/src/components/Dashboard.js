  ...
  const fetchData = async () => {
    try {
      ...
      const [
        ...
        axios.get('http://localhost:8000/api/statistics/dashboard', config),
        axios.get('http://localhost:8000/api/dashboard-config', config),
        axios.get('http://localhost:8000/api/assets', config),
        axios.get('http://localhost:8000/api/issues', config),
        axios.get('http://localhost:8000/api/statistics/assignee-workload', config),              // 추가!
        axios.get('http://localhost:8000/api/statistics/old-unresolved-issues?limit=5', config), // 추가!
        axios.get('http://localhost:8000/api/statistics/period-comparison', config)              // 추가!
      ]);
